...
using HabitAqui.ViewModels.Clientes;
...
namespace HabitAqui.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public ClientesController(ApplicationDbContext context, UserManager<Utilizadores> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (currentUser == null || _context.Arrendamentos == null)
            {
                return NotFound();
            }

            var arrendamentos = await _context.Utilizadores
                .FirstOrDefaultAsync(m => m.Id == currentUser.Id.ToString());
            if (arrendamentos == null)
            {
                return NotFound();
            }

            var arrendamentosUser = await _context.Arrendamentos.Where(u => u.UtilizadoresId == currentUser.Id).ToListAsync();
            ViewBag.ArrendamentosCount = arrendamentosUser.Count;
            var clienteViewModel = new ClienteViewModel
            {
                Username = currentUser.UserName,
                Ativo = currentUser.Ativo,
                Arrendamentos = arrendamentosUser
            };
        ...
        public IActionResult Index(ClienteViewModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? habitacaoId, ClienteViewModel model)
        {
