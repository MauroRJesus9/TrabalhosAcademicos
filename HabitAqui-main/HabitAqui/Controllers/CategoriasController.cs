...
namespace HabitAqui.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Disponivel")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Disponivel")] Categorias categorias)
        {
            if (id != categorias.Id)
            {
                return NotFound();
