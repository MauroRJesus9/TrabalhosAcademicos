...
namespace TPV2.Data.Migrations
{
    ...
    [Migration("20220113173623_AddPropertySC")]
    partial class AddPropertySC
    {
            ...
            modelBuilder.Entity("TPV2.Models.ScoreClient", b =>
                {
                    ...
                    b.HasOne("TPV2.Models.Properties", "PropertyScore")
                        .WithMany("PropertySC")
                        .HasForeignKey("PropertyId");
